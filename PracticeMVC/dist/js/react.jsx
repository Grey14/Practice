...
class Chosen2 extends React.Component {
    componentDidMount() {
        this.$el = $(this.el);
        this.$el.chosen();
...
//ReactDOM.render(
//    <MyComponent2 items={["3", "2", "1"]} onChange={value => console.log(value)} />,
//    document.getElementById('app')
//);

ReactDOM.render(
    <div>
        <Chosen2 items={["111", "222", "333"]} onChange={value => console.log(value)} />
        <MyComponent items={["vanilla", "chocolate", "strawberry"]} onChange={value => console.log(value)} />
        <Example />
    </div>,
    document.getElementById('app')
);